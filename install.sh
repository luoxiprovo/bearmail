...
main() {
    ...
    say ""
    say "AI agents (MCP stdio). Create a normal mailbox, issue a Stalwart API key"
    say "(starts with API_), then point the host at that mailbox. Never use a"
    say "human primary password or an app_… application password."
