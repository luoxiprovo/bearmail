...
export function AppShell({ children }: { children: ReactNode }) {
  const { config, client, username, online, lastSync, loadingData, refresh, logout, toasts } = useApp();
  ...
  return (
    <div className="app-shell">
      <aside className="sidebar" aria-label="Primary navigation">
        ...
        <nav>
          <NavLink to="/mail"><Inbox size={18} /> Mail</NavLink>
      ...
      <nav className="mobile-nav" aria-label="Mobile navigation">
        <NavLink to="/mail"><Inbox size={21} /><span>Mail</span></NavLink>
